...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Tap + on any screen for an expense or income. The date is already set to now.',
    scene: 'add',
    shape: 'pill',
    placement: 'above',
  },
  ...
  },
  {
    ...
    body: 'Switch between spending and income. Long-press any row to edit or delete it.',
    scene: 'ledger',
    shape: 'box',
    placement: 'below',
  },
